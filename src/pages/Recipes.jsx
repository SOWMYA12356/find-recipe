...
const Recipes = () => {
  ...
  const recipes = [
    { 
      ...
      ingredients: ["Mixed veggies", "soy sauce", "rice"],
      instructions: [
        "Heat oil in a pan.",
    ...
    { 
      ...
      ingredients: ["Overripe bananas", "eggs", "flour"], 
      instructions: [
    ...
    { 
      name: "Bread Pizza", 
      ingredients: ["Leftover bread", "tomato sauce", "cheese"],
      instructions: [
  ...
  return (
    <div className="recipes-container">
      ...
      <p className="recipes-subtitle">
        Turn your leftovers into something tasty and eco-friendly 🌿
      </p>
